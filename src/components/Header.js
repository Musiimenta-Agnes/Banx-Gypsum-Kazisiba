...
//         <nav className="navbar navbar-expand-lg bg-light" style={{ width: '100%', boxShadow: '0 2px 5px darkblue', height:'65px', position: 'relative', zIndex: 1000, backgroundColor:'#1F3C88', position:'fixed' }}>
...
//                 </li>
//                         <li className="custom-item nav-item">
//                   <Link to="/questions" className="custom-link nav-link" onClick={handleLinkClick}>FAQuestions</Link>
//                 </li>
